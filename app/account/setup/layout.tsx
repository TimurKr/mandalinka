...
export default async function Layout({
  ...
  const pages = [
    { label: 'Všeobecné informácie', url: '/account/setup/general' },
    { label: 'Notifikácie', url: '/account/setup/notifications' },
    { label: 'Adresy doručenia', url: '/account/setup/address' },
    { label: 'Preferencie', url: '/account/setup/preferences' },
    { label: 'História objednávok', url: '/account/setup/history' },
  ];
